...
class ValorantPlayer:
    ...
    async def get_account(self):
        url = url_json['account'].format(region=self.region, player_name=self.player_name, player_tag=self.player_tag)
    ...
    async def get_rank(self):
        url = url_json['rank'].format(region=self.region, player_name=self.player_name, player_tag=self.player_tag)
    ...
    async def get_match_stats(self):
        url = url_json['matches_v1'].format(region=self.region, player_name=self.player_name, player_tag=self.player_tag)
